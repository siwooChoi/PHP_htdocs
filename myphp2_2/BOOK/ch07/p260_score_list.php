<?php
  ...
  if(isset($_GET['mode']) && $_GET['mode']== "insert")
  {
    ...
    // $sum = $_POST['sub1'] +  $_POST['sub1'] + $_POST['sub3'] +
    //               $_POST['sub4'] + $_POST['sub5']
...
?>
  ...
  <form action="p260_score_list.php?mode=insert" method='post'>
  ...
  <h3> 2) 성적 출력 하기 </h3>
  <p><a href = "p260_score_list.php?mode=big_first">[성적순 정렬]</a>
     <a href = "p260_score_list.php?mode=small_first">[성적 역순 정렬]</a></p>
...
<?php
 ...
 while($row = mysql_fetch_array($result)){
   ...
   echo ("<tr align = 'center'>
      ...
      <td>$row[sum]</td>
      <td>$avg</td>
      <td><a href='p266_score_delete.php?num=$num'>[삭제]</a></td>
    </tr>
   ");
