...
<html>
  ...
  <body>
    ...
    <h2> > 회원가입</h2>
  <form name="mem_form" method="post" action="03mem_print.php">
    <input type="hidden" name="title" value="회원가입 양식">
    <table border="1" width="640" cellspacing="1" cellpadding="4">

      <tr>
        <td align="right"> * 아이디 : </td>
          <td> <input type="text" size="15" maxlength="12" name="id" value="이름 입력"> </td>
      </tr>
      ...
      <tr>
        <td align="right"> * 비밀번호 :</td>
          <td><input type="text" size="15" maxlength="12" name="passwd"></td>
      </tr>
