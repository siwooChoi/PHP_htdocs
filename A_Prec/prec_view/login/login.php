<?php
  ...
  ?>
    <table style="margin-top:50px;">
      <tr><td>
       <form action='./prec_con/control.php?mode=login' method="post">
       ...
       <form action="./prec_index.php?mode=createUser" method="post">
  ...
  <?php
      ...
      if($_SESSION["userid"] == "admin"){
        ...
        <table style="margin-top:50px; " >
          ...
          <tr>
            <td>
              <form action="./index./php?mode=upload_product1" method="post">
                <input type="submit" name = "upload_product" value="상품등록">
              </form>
            </td>

            <td>
              <form action="./.php?mode=logout" method="post">
