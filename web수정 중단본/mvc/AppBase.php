...
abstract class AppBase{
  ...
  //***run()***
    ...
    //Response객체에 저장되는 Rendering되는 Data를 응답으로 Client로 전송
  public function run(){
    try {
      ...
      // list($controller, $action) = $this->_tAction;
      list($controller, $action) = $this->_signinAction;
      var_dump($this->_signinAction);

      // $this->getContent($controller, "t");
